...
# Setup snippet: clear && sudo apt update && sudo apt upgrade -y && sudo snap install aws-cli --classic && aws s3 cp s3://gelc/setup.sh . && logout
...
aws s3 cp s3://gelc/env1 "$HOME"/my_env/s1/.env # Update each 'env<n>' file accordingly
...
aws s3 cp s3://gelc/env2 "$HOME"/my_env/s2/.env # Update each 'env<n>' file accordingly
...
aws s3 cp s3://gelc/env3 "$HOME"/my_env/s3/.env # Update each 'env<n>' file accordingly
...
aws s3 cp s3://gelc/env4 "$HOME"/my_env/s4/.env # Update each 'env<n>' file accordingly
...
aws s3 cp s3://gelc/env5 "$HOME"/my_env/s5/.env # Update each 'env<n>' file accordingly
...
aws s3 cp s3://gelc/env6 "$HOME"/my_env/s6/.env # Update each 'env<n>' file accordingly
...
aws s3 cp s3://gelc/env7 "$HOME"/my_env/s7/.env # Update each 'env<n>' file accordingly
...
aws s3 cp s3://gelc/env8 "$HOME"/my_env/s8/.env # Update each 'env<n>' file accordingly
...
aws s3 cp s3://gelc/env9 "$HOME"/my_env/s9/.env # Update each 'env<n>' file accordingly
...
aws s3 cp s3://gelc/env10 "$HOME"/my_env/s10/.env # Update each 'env<n>' file accordingly
...
aws s3 cp s3://gelc/env11 "$HOME"/my_env/s11/.env # Update each 'env<n>' file accordingly
...
aws s3 cp s3://gelc/env12 "$HOME"/my_env/s12/.env # Update each 'env<n>' file accordingly
...
aws s3 cp s3://gelc/env13 "$HOME"/my_env/s13/.env # Update each 'env<n>' file accordingly
...
aws s3 cp s3://gelc/env14 "$HOME"/my_env/s14/.env # Update each 'env<n>' file accordingly
...
aws s3 cp s3://gelc/env15 "$HOME"/my_env/s15/.env # Update each 'env<n>' file accordingly
